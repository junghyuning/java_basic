...
public class DayCaculateApp {
	public static void main(String[] args) {
		...
		try {
			...
			birthDay = dateFormat.parse(scanner.nextLine());  //이런식으로 변수 여러번 저장하지말고 한번에 하는 법도 있음.
			scanner.close();
		...
		System.out.println("[결과] 태어난지"+((System.currentTimeMillis()-birthDay.getTime())/1000/86400)+"일 지났습니다.");		
	}
