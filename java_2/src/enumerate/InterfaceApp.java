...
//상수필드 선언시, 발생할 수 있는 문제점
//=> 상수필드 값을 대표하는 단어로 사용하기 부적절한 경우 발생할 수 있음
//=> 상수필드가 선언된 클래스 또는 인터페이스는 아무런 의미 없이 접근 용도로만 사용
//Java에서는 상수필드 선언시 발생할 수 있는 문제점을 해결하기 위해 enum(열거형)이라는 참조형 자료형을 제공함.
public class InterfaceApp {
	public static void main(String[] args) {
		// 인터페이스에 선언된 상수필드값 출력 - 필드에 저장된 값 제공받아 출력하는 것.
