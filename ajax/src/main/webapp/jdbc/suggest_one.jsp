	...
	$("#keyword").keyup(function() {
		...
		$.ajax({
			...
			success: function(xmlDoc) {
				...
				if(code=="success") {//검색된 제시어 관련 정보가 있는 경우 - suggest_two의 <code>success</code> 엘리먼트
					var data=$(xmlDoc).find("data").text(); //success 영역의 data 태그
					//alert(data);
					...
					$("#suggestList").html(html); // div 태그의 suggestList에 html 출력
