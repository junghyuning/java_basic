...
<body>
	...
	<hr>
	<div>
		client platform 의 현재 날짜와 시간은 <span id="clientTime">2023년 7월 4일
			12시 22분 30초</span>
	</div>
	<div>
		server platform 의 현재 날짜와 시간은 <span id="serverTime">2023년 7월 4일
			12시 22분 30초</span>
	</div>

	<script type="text/javascript">
		//브라우저가 실행되는 클라이언트 플랫폼의 현재 날짜와 시간을 제공받아 태그를 변경하는 함수
		//=> 브라우저가 실행된 클라이언트에 따라 다른 결과 제공 가능 (-> 보완하기 위하여 서버 시간 사용 多)
